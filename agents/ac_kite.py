...
from utils.ac_test import ActorNetwork
from utils.ac_test import CriticNetwork
...
class DeepQAgent(base_agent.BaseAgent):
    ...
    def __init__(self):
        ...
        # saver.restore(self.sess, "./models/actorcritic_kite")

    def __del__(self):
        saver = tf.train.Saver()
        # saver.save(self.sess, "./models/actorcritic_kite")
    ...
    def step(self, obs):
        ...
        if (random.random() < EPSILON):
            ...
            args = [[0 if size == 2 else np.random.randint(0, size // 2 * 2) for size in arg.sizes]
            ...
            print(function_id, _POSSIBLE_ACTIONS)
        # print("3", self.steps)
